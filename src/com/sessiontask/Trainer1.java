...
public class Trainer1 {
	...
	public static void main(String[] args) {
		Trainer T1 = new Trainer(1,"Saba","Python",20000);
		Trainer T2 = new Trainer(2, "Arshil", "Java", 35000);
		Trainer T3 = new Trainer(3, "Farman", "JavaScript", 26000);
		Trainer T4 = new Trainer(4, "Sidrah", "Java", 28000);
		Trainer T5 = new Trainer(5, "Aamir", "C++", 19000);
...
class Trainer{
	...
	String course;
	double salary;
	public Trainer(int trainer_id, String name, String course, double salary) {

...
public class ComparatorJava {
	...
	public static void main(String[] args) {
		...
		movie.add(new Movies(4.2,"Sultan",2013));
		movie.add(new Movies(4.3,"Maine Pyaar Kiya",1995));
		movie.add(new Movies(3.9,"Main hu na",2000));
		movie.add(new Movies(4.6,"Ajab Prem ki Gajab Kahani",2003));
		movie.add(new Movies(4.9,"Jab we met",2005));
		int choice = 0;
		while(choice != 7) {
